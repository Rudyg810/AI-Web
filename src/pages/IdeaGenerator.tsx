...
<img width="100" height="100" src="https://img.icons8.com/ios/100/FD7E14/benzene-ring.png" alt="benzene-ring"/> 
  ...
  <div
    aria-hidden='true'
    className='pointer-events-none absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80 -left-[800px]'
  >
    <div
      style={{
        clipPath:
  ...
  <div
    aria-hidden='true'
    className='pointer-events-none absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80 sm:-right-[800px]'
  >
    <div
      style={{
        clipPath:
      ...
      className='relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#FFA500] to-[#FFD700] opacity-30 sm:right-[calc(50%-30rem)] sm:w-[72.1875rem]'
    />
  </div>
</div>
